...
void PLAYER_MovePlayer(PLAYER_Player* player)
{
    ...
    Vector3 trueSpeed = MY3DLIB_MATH_GetMultipliedVec(
        MY3DLIB_MATH_GetRotatedVecYAxis(MY3DLIB_MATH_GetRotatedVecXAxis(player->speed, player->rotation.x), player->rotation.y), ELAPSED
